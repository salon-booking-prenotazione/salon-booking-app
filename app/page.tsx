    ...
    <div className="relative overflow-hidden">
      ...
      <div
        ...
        style={{
          zIndex: -1,
          background:
            "radial-gradient(1200px 700px at 20% 10%, rgba(255,235,245,0.55), transparent 60%)," +
            "radial-gradient(900px 600px at 85% 15%, rgba(210,232,222,0.45), transparent 55%)," +
            "linear-gradient(180deg, rgba(248,245,240,0.70), rgba(248,245,240,0.90))",
        }}
      />
